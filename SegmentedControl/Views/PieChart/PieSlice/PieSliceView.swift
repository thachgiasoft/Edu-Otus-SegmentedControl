...
//  SegmentedControl
//
//  Created by Гена Книжник on 01.01.2020.
...
struct PieSliceView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        PieSliceView(rect: geometry.frame(in: .local),startDeg: 0.0,endDeg: 90.0, index: 0, backgroundColor: Color(red: 252.0/255.0, green: 236.0/255.0, blue: 234.0/255.0), accentColor: Color(red: 225.0/255.0, green: 97.0/255.0, blue: 76.0/255.0))
